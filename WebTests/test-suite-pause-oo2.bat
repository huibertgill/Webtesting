...
call casperjs test suite/oo2-login.js --includes=logger.js --proxy=10.16.36.38:3128 --proxy-auth=%PROXY_U%:%PROXY_P% --pre=pre-test.js --post=post-test.js --xunit=log.xml
pause